...
load_small="checkpoint_small/${dataset}/${type_small}_${small_recommendation_model}_${type}"
...
llm_root_dir="/data/lvzheqi/lvzheqi/ICLR2023/LLM/llm"
...
python -m torch.distributed.launch \
    ...
    --master_port ${port} \
    src/pretrain_recommendation_collaboration.py \
