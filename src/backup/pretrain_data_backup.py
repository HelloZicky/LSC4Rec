...
class P5_Amazon_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.args.mode == "large_language_model":
            if task_name == 'rating':
        ...
        elif self.args.mode == "small_recommendation_model":
            # elif task_name == 'traditional':
            sequential_datum = self.sequential_data[datum_idx]
            sequence = sequential_datum.split()
            user_id = sequence[0]
            ...
            out_dict[consts.FIELD_USER_ID] = "traditional"
            out_dict[consts.FIELD_TARGET_ID] = "traditional"
            out_dict[consts.FIELD_CLK_SEQUENCE] = "traditional"
            out_dict[consts.FIELD_LABEL] = "traditional"
            out_dict['task'] = "traditional"
            out_dict['mode'] = "small_recommendation_model"

            return out_dict
        # elif self.args.mode == "collaboration":
