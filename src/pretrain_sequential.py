...
def main_worker(gpu, args):
    ...
    if args.train == 'yelp':
        ...
        train_task_list = {'sequential': ['2-1', '2-2', '2-3', '2-4', '2-5', '2-6', '2-7', '2-8', '2-9', '2-10', '2-11', '2-12']}
    else:
        # train_task_list = {'traditional': ['5-1', '5-2', '5-3', '5-4']}
        train_task_list = {'sequential': ['2-1', '2-2', '2-3', '2-4', '2-5', '2-6', '2-7', '2-8', '2-9', '2-10', '2-11', '2-12']}
    ...
    if args.valid == 'yelp':
        ...
        val_task_list = {'sequential': ['2-1', '2-2', '2-3', '2-4', '2-5', '2-6', '2-7', '2-8', '2-9', '2-10', '2-11', '2-12']}
    else:
        # val_task_list = {'traditional': ['5-1', '5-2', '5-3', '5-4']}
        val_task_list = {'sequential': ['2-1', '2-2', '2-3', '2-4', '2-5', '2-6', '2-7', '2-8', '2-9', '2-10', '2-11', '2-12']}
