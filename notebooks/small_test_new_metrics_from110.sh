...
#dataset_list=("beauty" "yelp")
#dataset_list=("beauty" "sports" "toys")
#dataset_list=("beauty")
#dataset_list=("yelp")
#dataset_list=("sports" "toys")
#dataset_list=("sports")
#dataset_list=("toys")
echo ${dataset_list}
line_num_list=(7828 21189 30819)
#cuda_num_list=(0 1 2 3)
#cuda_num_list=(0 3 4 5)
cuda_num_list=(4 5 6 7)
#cuda_num_list=(0 1 2)
#cuda_num_list=(2 3)
#cuda_num_list=(1 2 3)
#cuda_num_list=(4 5)
...
#    for model in sasrec
#    for model in gru4rec
#    for model in din
#    for model in din gru4rec
...
#                        for losses in traditional sequential
                        for losses in sequential
#                        for losses in traditional
                        do
                          {
                            framework=${framework}_${type}
#                            bash func_small_test_new_metrics_from110.sh ${dataset} ${framework} ${model} 2 ${type} ${losses}
                            bash func_small_test_new_metrics_from110.sh ${dataset} ${framework} ${model} ${cuda_num} ${type} ${losses}
                          } &
                        done
                    } &
                  done
